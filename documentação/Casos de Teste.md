...
- O anúncio deve ser criado com sucesso no sistema de e-commerce.
...
- O sistema deve exibir uma mensagem de erro clara indicando as inconsistências de dados. O pedido não deve ser atualizado.
